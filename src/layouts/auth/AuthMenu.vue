<template>
  <div>
    <div class="column flex-center">
      <q-icon name="person" size="3rem" class="q-mt-lg" />
    </div>
    ...
    >
      ...
      <q-item clickable @click="$router.push('/admin/home')">
        <q-item-section avatar>
          <q-icon name="home" />
        </q-item-section>
        <q-item-section>
    ...
    <br />
    <q-list v-if="this.$auth.check('superuser')" no-border link inset-delimiter>
      <q-item-label header>
        {{ $t("auth.superuser.title") }}
      </q-item-label>
      <q-item clickable @click="$router.push('/superuser/users')">
        <q-item-section avatar>
          <q-icon name="people" />
        </q-item-section>
        <q-item-section>
